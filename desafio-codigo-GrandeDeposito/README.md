...
Entrada
O programa deve utilizar o equipamentos.digitalizadora.Scanner para receber o valor de depósito digitado pelo cliente. Os valor pode ser decimal, representando valor em reais.
